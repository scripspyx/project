...
tampilan() {
    ...
    allowed_ips_url="https://raw.githubusercontent.com/scripspyx/project/main/ip"
...
echo ""
clear
REPO="https://raw.githubusercontent.com/scripspyx/project/main/"
start=$(date +%s)
secs_to_human() {
...
memasang_notifikasi_bot() {
  ...
  local izinsc="https://raw.githubusercontent.com/scripspyx/project/main/ip"
  ...
  local CHATID="1271728266"
  local KEY="8245934046:AAGFrHyo4NM3KHZcE5VxN1RxAtgoP7w-61Q"
...
"
  ...
  local INLINE_KEYBOARD='{"inline_keyboard":[[{"text":"Telegram","url":"https://t.me/GallVpnStore"}]]}'
